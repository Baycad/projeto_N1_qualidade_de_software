    ...
    const checkMonthlyReset = () => {
      ...
      if (currentDate === 1) {
        ...
        if (lastReset !== currentMonthKey) {
          ...
          console.log("[v0] Monthly reset completed for Lucas")
        }
      }
    }
    ...
    >
      <div className="max-w-7xl mx-auto space-y-6">
            ...
            <div className="flex flex-col items-center space-y-4">
              <div className="relative">
                <Avatar className="w-40 h-40 border-4 border-blue-200">
                  ...
                  <AvatarFallback className="text-4xl bg-blue-100 text-blue-700">LC</AvatarFallback>
                </Avatar>
                <Button
                  size="sm"
                  variant="secondary"
              ...
              <div className="w-full max-w-md space-y-2">
                <div className="flex justify-between items-center">
                  <Label className={isDarkMode ? "text-gray-300" : "text-slate-700"}>Limite Mensal</Label>
                  <Dialog>
                    ...
                    <DialogContent className={isDarkMode ? "bg-gray-800 border-gray-700" : ""}>
                      <DialogHeader>
                        <DialogTitle className={isDarkMode ? "text-white" : ""}>Editar Limite Mensal</DialogTitle>
                      </DialogHeader>
                ...
                <Progress
                  ...
                  className="h-3"
                  style={{
                    background: progressPercentage > 90 ? "#fee2e2" : progressPercentage > 70 ? "#fef3c7" : "#dcfce7",
                  }}
                />
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
          <Card className="bg-gradient-to-br from-green-50 to-green-100 border-green-200">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-700 text-sm font-medium">Saldo Total</p>
                  <p className="text-2xl font-bold text-green-800">R$ {totalBalance.toFixed(2)}</p>
                </div>
            ...
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-2xl font-bold text-blue-800">R$ {totalIncome.toFixed(2)}</p>
                </div>
                <div className="flex items-center gap-2">
                  <Dialog>
                    ...
                    <DialogContent className={isDarkMode ? "bg-gray-800 border-gray-700" : ""}>
                      <DialogHeader>
                        <DialogTitle className={isDarkMode ? "text-white" : ""}>Adicionar Entrada</DialogTitle>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Valor</Label>
                          <Input
                            value={newIncome.amount}
                            onChange={(e) => setNewIncome({ amount: formatCurrency(e.target.value) })}
                            placeholder="R$ 0,00"
                            className={isDarkMode ? "bg-gray-700 border-gray-600 text-white" : ""}
                          />
                        </div>
                        <Button onClick={addIncome} className="w-full bg-blue-600 hover:bg-blue-700">
                          Adicionar Entrada
                        </Button>
                      </div>
                    </DialogContent>
          ...
          <Card className="bg-gradient-to-br from-orange-50 to-orange-100 border-orange-200">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-orange-700 text-sm font-medium">Compras Parceladas</p>
                  <p className="text-2xl font-bold text-orange-800">R$ {totalInstallmentRemaining.toFixed(2)}</p>
                  <p className="text-xs text-orange-600 mt-1">
                    {totalInstallmentItems} {totalInstallmentItems === 1 ? "item restante" : "itens restantes"}
                  </p>
                </div>
          ...
          <Card className="bg-gradient-to-br from-purple-50 to-purple-100 border-purple-200">
            <CardContent className="pt-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-purple-700 text-sm font-medium">Investimentos</p>
                  <p className="text-2xl font-bold text-purple-800">R$ {investment.toFixed(2)}</p>
                </div>
                <div className="flex items-center gap-2">
                  <Dialog>
                    <DialogTrigger asChild>
                    ...
                    <DialogContent className={isDarkMode ? "bg-gray-800 border-gray-700" : ""}>
                      <DialogHeader>
                        <DialogTitle className={isDarkMode ? "text-white" : ""}>Adicionar Investimento</DialogTitle>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Valor</Label>
                          <Input
                            ...
                            onChange={(e) => setNewInvestment({ amount: formatCurrency(e.target.value) })}
                            placeholder="R$ 0,00"
                            className={isDarkMode ? "bg-gray-700 border-gray-600 text-white" : ""}
                          />
                        </div>
                        <Button onClick={addInvestment} className="w-full bg-purple-600 hover:bg-purple-700">
        ...
        <Tabs defaultValue="expenses" className="space-y-4">
          <TabsList className={`grid w-full grid-cols-3 ${isDarkMode ? "bg-gray-800/80" : "bg-white/80"}`}>
          ...
          <TabsContent value="expenses">
            ...
            >
              <CardHeader>
                <div className="flex justify-between items-center">
                  <CardTitle className={isDarkMode ? "text-white" : "text-slate-800"}>Planilha de Gastos</CardTitle>
                  <Dialog>
                    <DialogTrigger asChild>
                    ...
                    <DialogContent className={isDarkMode ? "bg-gray-800 border-gray-700" : ""}>
                      <DialogHeader>
                        <DialogTitle className={isDarkMode ? "text-white" : ""}>Adicionar Novo Gasto</DialogTitle>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Categoria</Label>
                          <Select
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) => setNewExpense({ ...newExpense, amount: formatCurrency(e.target.value) })}
                            placeholder="R$ 0,00"
                            className={isDarkMode ? "bg-gray-700 border-gray-600 text-white" : ""}
                          />
                        </div>
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Data</Label>
                          <Input
                            type="date"
                        ...
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Descrição (opcional)</Label>
                          <Textarea
              ...
              <CardContent>
                {expenses.length === 0 ? (
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Categoria</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Valor</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Data</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Descrição</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Ações</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
          ...
          <TabsContent value="fixed">
            ...
            >
              <CardHeader>
                <div className="flex justify-between items-center">
                  <CardTitle className={isDarkMode ? "text-white" : "text-slate-800"}>Gastos Fixos</CardTitle>
                  <Dialog>
                    <DialogTrigger asChild>
                      <Button className="bg-blue-600 hover:bg-blue-700">
                        <Plus className="w-4 h-4 mr-2" />
                    ...
                    <DialogContent className={isDarkMode ? "bg-gray-800 border-gray-700" : ""}>
                      <DialogHeader>
                        <DialogTitle className={isDarkMode ? "text-white" : ""}>Adicionar Gasto Fixo</DialogTitle>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Categoria</Label>
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setNewFixedExpense({ ...newFixedExpense, amount: formatCurrency(e.target.value) })
                            }
                            placeholder="R$ 0,00"
                            className={isDarkMode ? "bg-gray-700 border-gray-600 text-white" : ""}
                          />
                        ...
                        <Button onClick={addFixedExpense} className="w-full bg-blue-600 hover:bg-blue-700">
              ...
              <CardContent>
                {fixedExpenses.length === 0 ? (
                  <div className={`text-center py-8 ${isDarkMode ? "text-gray-400" : "text-slate-500"}`}>
                    Nenhum gasto fixo registrado ainda. Adicione seu primeiro gasto fixo!
                  </div>
                ) : (
                  <Table>
                    <TableHeader>
                    ...
                    <TableBody>
                      {fixedExpenses.map((expense) => (
                        <TableRow key={expense.id} className={expense.isPaid ? "opacity-60" : ""}>
                          <TableCell className={`font-medium ${isDarkMode ? "text-white" : ""}`}>
                            {expense.category}
                          </TableCell>
                          <TableCell
                            className={`font-medium ${expense.isPaid ? "text-gray-500 line-through" : "text-red-600"}`}
                          >
          ...
          <TabsContent value="installments">
            ...
            >
              <CardHeader>
                <div className="flex justify-between items-center">
                  <CardTitle className={`flex items-center ${isDarkMode ? "text-white" : "text-slate-800"}`}>
                  ...
                  <Dialog>
                    ...
                    <DialogContent className={isDarkMode ? "bg-gray-800 border-gray-700" : ""}>
                      <DialogHeader>
                        <DialogTitle className={isDarkMode ? "text-white" : ""}>Adicionar Compra Parcelada</DialogTitle>
                      </DialogHeader>
                      <div className="space-y-4">
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Tipo/Descrição</Label>
                          <Input
                        ...
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Valor Total</Label>
                          <Input
                            value={newInstallment.totalAmount}
                            onChange={(e) =>
                              setNewInstallment({ ...newInstallment, totalAmount: formatCurrency(e.target.value) })
                            }
                            placeholder="R$ 0,00"
                            className={isDarkMode ? "bg-gray-700 border-gray-600 text-white" : ""}
                          />
                        ...
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Total de Parcelas</Label>
                          <Input
                            type="number"
                            value={newInstallment.totalInstallments}
                            onChange={(e) =>
                              setNewInstallment({ ...newInstallment, totalInstallments: e.target.value })
                            }
                            placeholder="Ex: 12"
                            min="1"
                            className={isDarkMode ? "bg-gray-700 border-gray-600 text-white" : ""}
                        ...
                        <div>
                          <Label className={isDarkMode ? "text-gray-300" : ""}>Valor Restante</Label>
                          <Input
                        ...
                        <Button onClick={addInstallment} className="w-full bg-blue-600 hover:bg-blue-700">
              ...
              <CardContent>
                {installments.length === 0 ? (
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Item</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Valor Total</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Parcela Mensal</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Progresso</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Status</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Ações</TableHead>
                        <TableHead className={isDarkMode ? "text-gray-300" : ""}>Pago</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                      {installments.map((item) => (
                        <TableRow key={item.id}>
                          <TableCell className={`font-medium ${isDarkMode ? "text-white" : ""}`}>{item.name}</TableCell>
                          <TableCell className={isDarkMode ? "text-gray-300" : ""}>
                            R$ {item.totalAmount.toFixed(2)}
                          </TableCell>
                          <TableCell className="text-red-600 font-medium">R$ {item.monthlyAmount.toFixed(2)}</TableCell>
                          <TableCell>
                            <div className="space-y-1">
                              <Progress
                                value={((item.totalAmount - item.remainingAmount) / item.totalAmount) * 100}
                          ...
                          <TableCell>
                            <div className="flex gap-1">
                              <Button
                                size="sm"
                                variant="outline"
                                onClick={() => updateInstallmentPayment(item.id, false)}
                                disabled={item.remainingAmount >= item.totalAmount}
                              ...
                              <Button
                                size="sm"
                                variant="outline"
                                onClick={() => updateInstallmentPayment(item.id, true)}
